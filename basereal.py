...
from ttsreal import EdgeTTS,SovitsTTS,XTTS,CosyVoiceTTS,FishTTS,TencentTTS,DoubaoTTS,IndexTTS2,AzureTTS,QwenTTS
...
class BaseReal:
    ...
    def set_tts_options(self, options: dict):
        if hasattr(self.tts, "set_tts_options"):
            self.tts.set_tts_options(options)

    def get_tts_options(self):
        if hasattr(self.tts, "get_tts_options"):
            return self.tts.get_tts_options()
        return {}
